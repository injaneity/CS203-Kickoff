  ...
  return (
    <div className="flex flex-col space-y-2">
      <div className="flex justify-between">
        ...
        <span className="text-sm">{value[0]} - {value[1]}</span>
      </div>
      <Slider.Root
      ...
      >
        ...
        <Slider.Thumb className="block w-5 h-5 bg-white rounded-full hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-600" />
        <Slider.Thumb className="block w-5 h-5 bg-white rounded-full hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-600" />
      </Slider.Root>
    </div>
  );
